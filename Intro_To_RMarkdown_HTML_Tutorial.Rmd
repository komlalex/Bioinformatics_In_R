...
We can also add tabs in our report. To do this you need to specify each section that you want to become a tab by placing "{.tabset}" after the line. Every subsequent heade will be a new tab.